...
$language['create_account_tip2'] = 'Download the Wrath of the Lich King client. You can get a copy here: %s';
...
$language['create_account_tip3'] = 'Extract the client wherever you like. I recommend placing it at the root of your user folder at "C:\Users\yourUsername\World of Warcraft - WotLK" so you do not need Administrator rights to run the client, and it will be outside your OneDrive sync scope if you have that configured. Open the newly extracted directory then drill down to data, enUS.';
